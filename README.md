...
```
Simulated Automated Docking of a mobile robot to a charging station in gazebo using ROS and computer vision
which involved Navigation, localization and path planning.
